...
jQuery(document).ready(function() {
	...
	jQuery('.add_slide_btn').click(function () {
		...
		jQuery('<dt class="slide_ttl" id="slide_dt_'+slidenum+'"><img src="'+img+'" width="56" height="56" alt="'+ttl+'" title="'+ttl+'" /></dt><dd class="slide_item" id="slide_dd_'+slidenum+'">'+ddhtml+'</dd>').insertBefore('.add_dt');
		readyToUpload();
	});
	...
	jQuery('.addselect').live('change', function() {
		...
		if (val!=0) { //���� ������ �����
			var newadd=jQuery(this).clone();//c������� ��� ���� ������ �� ��������
