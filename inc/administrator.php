...
class AdminPage {
    ...
    function loadHeadTemplate() {
        if (isset($_GET['page']) && $_GET['page'] == 'OptionsPage')
            $_GET['page'] = 'general';
        if ((isset($this->PageOptions[$_GET['page']])) && (is_array($this->PageOptions[$_GET['page']]))) {
            ?>
    ...
    function ThemeOptionsPage() {
        ...
        <div class="wrap">
            <?php
            if ($_GET['page'] == 'updates' || $_GET['page'] == 'activate' || $_GET['page'] == 'contacts') {
            ...
            <br>
            <!--            <div class='smthemes-top'>
                            <img src="<?php // echo get_template_directory_uri()   ?>/inc/images/logo.png" alt="SMThemes.com" style='' />
    ...
    function load_tabs_content($type = 0) {
        ...
        if (is_array($this->PageOptions) && count($this->PageOptions > 0)) {
            foreach ($this->PageOptions as $href => $x) {
                ...
                if ($href != 'activate')
                    echo '<form id="form_' . $href . '" method="POST">';
        ...
        switch ($param['type']) {
            ...
            case 'check':
                if (isset($param['depend'])) {
                    ...
                    if (!preg_match('/' . $param['depend'] . '/', $plugins))
                        break;
                }
                ?>
                <div class='item'>
